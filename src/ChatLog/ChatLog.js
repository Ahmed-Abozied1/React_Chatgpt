          ...
          <div className="avatar chatgpt">
            <svg xmlns="http://www.w3.org/2000/svg"
             ...
             fill-rule="evenodd" clip-rule="evenodd"
              viewBox="0 0 512 512"><rect fill="#10A37F"
               width="512" height="512" rx="104.187"
                ry="105.042"/><path fill="#fff"
                 fill-rule="nonzero"
